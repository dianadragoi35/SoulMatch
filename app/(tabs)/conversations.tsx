...
const ConversationsScreen = () => {
    ...
    try {
      ...
      if (conversationsData) {
        ...
        const sortedConversations = parsedConversations.sort((a, b) => {
          ...
          return (
            new Date(lastMessageB.timestamp).getTime() - new Date(lastMessageA.timestamp).getTime()
          );
        });
  ...
  const ConversationItem = ({ conversation }: { conversation: Conversation }) => {
    ...
    return (
      <TouchableOpacity style={styles.conversationItem} onPress={() => openChat(conversation)}>
        ...
        <View style={styles.lastMessageContainer}>
          <Text
            style={[styles.lastMessageText, isLastMessageFromMatch && styles.unreadMessage]}
            numberOfLines={2}
          >
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.header}>
          ...
          <View style={styles.headerActions}>
            <TouchableOpacity style={styles.headerButton} onPress={() => router.push('/discover')}>
