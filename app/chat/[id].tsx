    ...
    const renderMessage = ({ item }: { item: Message }) => (
        <View style={[
            ...
            item.sender === 'user' ? styles.userMessageContainer :
                item.sender === 'system' ? styles.systemMessageContainer : styles.matchMessageContainer
        ]}>
            <View style={[
                styles.messageBubble,
                item.sender === 'user' ? styles.userMessage :
                    item.sender === 'system' ? styles.systemMessage : styles.matchMessage
            ]}>
                <Text style={[
                    styles.messageText,
                    item.sender === 'user' ? styles.userMessageText :
                        item.sender === 'system' ? styles.systemMessageText : styles.matchMessageText
                ]}>
                    {item.text}
                </Text>
            </View>
